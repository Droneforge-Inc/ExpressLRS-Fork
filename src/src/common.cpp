...
expresslrs_mod_settings_s ExpressLRS_AirRateConfig[RATE_MAX] = {
    ...
    {10,RADIO_TYPE_SX128x_LORA, RATE_LORA_500HZ_FCC, SX1280_LORA_BW_1600,         SX1280_LORA_SF5,  SX1280_LORA_CR_LI_4_8, 20, TLM_RATIO_1_2,   1,  2000, OTA8_PACKET_SIZE, 0xFF} // FCC test case
};
...
expresslrs_rf_pref_params_s ExpressLRS_AirRateRFperf[RATE_MAX] = {
    ...
    {8, -112,  7605, 3500, 2500, 11, 5000, SNR_SCALE( 0), SNR_SCALE(8.5)},
    {9, -115, 10798, 4000, 2500,  0, 5000, SNR_SCALE(-1), SNR_SCALE(6.5)},
    {10, -90,   389, 1000, 1000, 13, 1000, DYNPOWER_SNR_THRESH_NONE, DYNPOWER_SNR_THRESH_NONE}}; // FCC max emissions test
#endif
